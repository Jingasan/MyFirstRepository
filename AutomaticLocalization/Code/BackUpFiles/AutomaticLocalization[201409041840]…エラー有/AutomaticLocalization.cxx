...
#pragma omp parallel
	...
	Eigen::Matrix< double, 3, 3 > *ER = NULL;			// 全探索結果の回転行列 R
	Eigen::Vector3d *Et = NULL;							// 全探索結果の並進ベクトル t
	int *EDFval = NULL;									// 全探索結果のDF評価値の合計値：小さいものから順に格納
	...
	ExhaustiveSearch(
		...
		&ER,				// 全探索結果の回転行列 R
		&Et,				// 全探索結果の並進ベクトル t
		&EDFval				// 全探索結果のDF評価値の合計値：小さいものから順に格納
	);

...
const char ExhaustiveSearchParameterFileName[] = "Output/ExhaustiveSearchResult/SearchingParameters.csv";			// 全探索後の探索パラメータ
const char ExhaustiveSearchRMSEFileName[] = "Output/ExhaustiveSearchResult/ExhaustiveSearch_RMSE.csv";				// 全探索後のRMSE評価値
const char CPDistanceAfterESFileName[] = "Output/ExhaustiveSearchResult/CPDistance.csv";							// 対応点(最近点)間の距離
...
const char CPDistanceAfterICPFileName[] = "Output/ICPResult/CPDistance.csv";		// 対応点(最近点)間の距離
